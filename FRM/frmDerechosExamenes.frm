...
Begin VB.Form frmDerechosExamenes 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin isButtonTest.isButton cmdAgregar 
         ...
         _ExtentX        =   2355
         _ExtentY        =   741
         Icon            =   "frmDerechosExamenes.frx":EBE8
         Style           =   8
         Caption         =   "     Aceptar"
         IconSize        =   18
         IconAlign       =   1
      ...
      Begin isButtonTest.isButton cmdExamenes 
         ...
         _ExtentX        =   2355
         _ExtentY        =   741
         Icon            =   "frmDerechosExamenes.frx":F4C2
         Style           =   8
         Caption         =   "     Examen"
         IconSize        =   18
         IconAlign       =   1
...
Private Sub CargarModulos()
    ...
    ElseIf txtCurso.Text = "Diseño Grafico" Then
        With cmbModulo
            .Clear
            .AddItem ("Windows")
            .AddItem ("Corel Draw")
    ...
    ElseIf txtCurso.Text = "Programacion" Or txtCurso.Text = "Telefonia Celular" Then
        With cmbModulo
            .Clear
            .AddItem ("Modulo I")
            .AddItem ("Modulo II")
    ...
    ElseIf txtCurso.Text = "Tecnico en aire acondicionado" Or txtCurso.Text = "Electricidad domiciliaria" Then
        With cmbModulo
            .Clear
            .AddItem ("Modulo I")
            .AddItem ("Modulo II")
    ...
    ElseIf txtCurso.Text = "Ingles" Or txtCurso.Text = "Ingles II" Then
        With cmbModulo
            .Clear
            .AddItem ("Ingles I")
            .AddItem ("Ingles II")
