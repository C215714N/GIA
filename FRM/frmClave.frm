...
'''Configuracion proximo Mes - Fecha Futura
    ...
    '''Usuario Cobranzas - Gestion Comercial
       ...
       '''error de ingreso
        Else
            MsgBox "Usuario o clave incorrecta." & vbNewLine & "Ingrese un usuario y contrase�a validos", vbOKOnly + vbInformation, "Gestion Integral del Alumno": txtUsuario.SetFocus: Exit Sub
            Exit Sub
        End If
