VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} dtrPresupuesto 
   Caption         =   "AdmPAT - dtrPresupuesto (DataReport)"
   ClientHeight    =   6435
   ClientLeft      =   5580
   ClientTop       =   1875
   ClientWidth     =   10320
   Icon            =   "dtrPresupuesto.dsx":0000
   MDIChild        =   -1  'True
   _ExtentX        =   18203
   _ExtentY        =   11351
   _Version        =   393216
   ...
   EndProperty
End
Attribute VB_Name = "dtrPresupuesto"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_QueryClose(Cancel As Integer, CloseMode As Integer)
    frmPresupuesto.Enabled = True
End Sub
